...
# تعرفه‌های پیش‌فرض سرویس تک لوکیشن - فقط در اولین اجرا استفاده میشه
DEFAULT_SINGLE_PLANS = [
    ("تک کاربره نامحدود یک‌ماهه", 100000),
    ("دو کاربره نامحدود یک‌ماهه", 180000),
    ("تک کاربره نامحدود دو‌ماهه", 180000),
]
